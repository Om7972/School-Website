...
const SchoolInfrastructure = () => {
  const facilities = [
    ...
    },
    {
      ...
      description: "Extensive library with thousands of books, digital resources, and quiet reading spaces for students.",
    ...
    },
    {
      ...
      title: "Auditorium",
      description: "Large, well-equipped auditorium for assemblies, cultural events, and presentations with modern sound and lighting systems.",
    ...
    },
    {
      ...
      title: "Cafeteria",
      description: "Hygienic cafeteria serving nutritious meals and snacks with a comfortable dining area for students and staff.",
      image: "https://images.unsplash.com/photo-1556910096-6f5e72db6803?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
    },
    {
      icon: (
      ...
      title: "Medical Room",
      description: "Fully equipped medical room with first aid facilities and qualified medical staff available during school hours.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-cyan-600 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Our school boasts modern, well-maintained infrastructure designed to provide students with a comfortable, safe, and conducive learning environment that supports academic excellence and holistic development.
              </p>
      ...
      {/* Stats Section */}
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white -mt-8 relative z-10">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">Our Facilities</h2>
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              Explore the comprehensive range of facilities available at our school.
            </p>
          </div>
            ...
            {facilities.map((facility, index) => (
              <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-lg border border-slate-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-slate-800 mb-3">{facility.title}</h3>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-6">Infrastructure Highlights</h2>
              <p className="text-lg text-slate-600 mb-8">
                Our school infrastructure is designed with student comfort, safety, and learning effectiveness in mind. We continuously upgrade our facilities to meet modern educational standards.
              </p>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-slate-700 text-lg">Climate-controlled classrooms with modern amenities</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <svg className="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-slate-700 text-lg">Wi-Fi enabled campus with high-speed internet connectivity</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <svg className="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-slate-700 text-lg">Security systems and CCTV surveillance for student safety</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <svg className="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-slate-700 text-lg">Accessible infrastructure for differently-abled students</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <svg className="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-slate-700 text-lg">Eco-friendly campus with green spaces and gardens</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-cyan-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Visit our campus and see how our infrastructure supports exceptional learning experiences.
          </p>
